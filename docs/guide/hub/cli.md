...
| `nhub update`       | `--yes` installs without asking; `--package <file>` installs a package file instead of the newest release                                                       | yes  | Installs the newest release of the hub through a unit that gates on health and rolls back, and waits for the result.          |
