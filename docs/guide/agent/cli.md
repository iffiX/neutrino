...
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| `nagent join <link>` | `<link>` is the `neutrino://enroll/` link from the hub; with it omitted, the command prompts for it. `--yes` replaces an existing binding without a confirmation prompt   | Joins the hub the link names: writes the binding and starts the service.                              |
| `nagent leave`       |                                                                                                                                                                           | Leaves the hub and removes the binding.                                                               |
