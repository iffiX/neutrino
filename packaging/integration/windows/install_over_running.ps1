...
Write-Output ("pythonw before: " + ((Get-Process pythonw -ErrorAction SilentlyContinue | ForEach-Object { $_.Id }) -join ','))
...
Write-Output ("pythonw after: " + ((Get-Process pythonw -ErrorAction SilentlyContinue | ForEach-Object { $_.Id }) -join ','))
