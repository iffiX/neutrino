...
@router.get("/ssh_key", response_model=KeyListView)
...
@router.post("/ssh_key/add", response_model=KeyView)
...
@router.get("/login", response_model=LoginListView)
...
@router.post("/login/add", response_model=LoginView)
...
@router.get("/token", response_model=TokenListView)
...
@router.post("/token/add", response_model=TokenView)
...
def delete_token(
    request: CredentialTokenRequest, runtime: PanelRuntime = Depends(get_runtime)
) -> dict:
    ...
    Args:
        request: The token's identifier.
