"""The ZFS block: which devices carry the tools, and each one's storage.
...
@router.post("/scan", response_model=ZfsDeviceView)
def scan_disks(
...
@router.post("/pool/create", response_model=ZfsDeviceView)
def create_pool(
    ...
    Args:
        request: The device, and name, layout, and the member disks by id.
        runtime: The shared runtime.
    ...
    return _op(
        ...
        request.device_id,
        "create_pool",
        request.model_dump(exclude={"device_id"}),
    )


@router.post("/pool/destroy", response_model=ZfsDeviceView)
def destroy_pool(
    request: ZfsPoolRequest, runtime: PanelRuntime = Depends(get_runtime)
) -> ZfsDeviceView:
    ...
    Args:
        request: The device and the pool. The page asked for its name to be
            typed back.
        runtime: The shared runtime.
...
@router.post("/pool/scrub", response_model=ZfsDeviceView)
def scrub(
    request: ZfsPoolRequest, runtime: PanelRuntime = Depends(get_runtime)
) -> ZfsDeviceView:
    """Start scrubbing a pool."""
    return _op(runtime, request.device_id, "scrub", {"name": request.name})


@router.post("/pool/scrub/stop", response_model=ZfsDeviceView)
def stop_scrub(
    request: ZfsPoolRequest, runtime: PanelRuntime = Depends(get_runtime)
) -> ZfsDeviceView:
    """Stop a running scrub."""
    return _op(runtime, request.device_id, "stop_scrub", {"name": request.name})


@router.post("/pool/expand", response_model=ZfsDeviceView)
def expand_pool(
...
@router.post("/pool/replace", response_model=ZfsDeviceView)
def replace_disk(
...
@router.post("/pool/offline", response_model=ZfsDeviceView)
def offline_disk(
...
@router.post("/pool/online", response_model=ZfsDeviceView)
def online_disk(
    request: ZfsDiskActionRequest,
    runtime: PanelRuntime = Depends(get_runtime),
) -> ZfsDeviceView:
...
@router.post("/pool/import", response_model=ZfsDeviceView)
def import_pool(
    request: ZfsPoolRequest, runtime: PanelRuntime = Depends(get_runtime)
) -> ZfsDeviceView:
    """Import a pool found on attached disks."""
    return _op(runtime, request.device_id, "import_pool", {"name": request.name})


@router.post("/dataset/create", response_model=ZfsDeviceView)
def create_dataset(
...
@router.post("/dataset/destroy", response_model=ZfsDeviceView)
def destroy_dataset(
...
@router.post("/dataset/share", response_model=ZfsDeviceView)
def share_dataset(
    ...
    Args:
        request: The device, the dataset and who may open the share.
        runtime: The shared runtime.
...
@router.post("/dataset/unshare", response_model=ZfsDeviceView)
def unshare_dataset(
    request: ZfsDatasetRequest,
    runtime: PanelRuntime = Depends(get_runtime),
) -> ZfsDeviceView:
