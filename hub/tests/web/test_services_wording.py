...
no word for is a row that says nothing about why it is unhealthy. Asserting
the table both ways means a new code fails this suite until it is worded, and
a word left behind by a retired code fails it too.
"""
...
from neutrino_hub.modules.services.constants import SERVICES_PROBE_DETAIL_CODES
