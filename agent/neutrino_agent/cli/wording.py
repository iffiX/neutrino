...
CLI_CODE_WORDS = {
    ...
    "uninstall_failed": "the uninstall failed: {detail}",
    ...
    "package_digest_mismatch": "what arrived did not match the hub's checksum",
    ...
    "shell_unknown": "no shell stream {shell} is open",
