...
One connection to the hub's agent port: an HTTP/1.1 upgrade, then RFC 6455
...
class WebSocketClient:
    ...
    def __init__(
        ...
        *,
        ...
        path: str,
        fingerprint: str,
        timeout_s: float = AGENT_REQUEST_TIMEOUT_S,
        silence_timeout_s: float = AGENT_WS_SILENCE_TIMEOUT_S,
    ):
        """
        Args:
